...
class AXTabGroupSwapperView: NSView {
    ...
    lazy var imageView: NSImageView = {
        ...
        imageView.image = NSImage(systemSymbolName: "square.3.layers.3d", accessibilityDescription: nil)
    ...
    override func viewWillDraw() {
        ...
        NSLayoutConstraint.activate([
            ...
            tabGroupLabel.leftAnchor.constraint(equalTo: imageView.rightAnchor, constant: 6),
            tabGroupLabel.rightAnchor.constraint(equalTo: rightAnchor),
            
            // Profile label constraints
            profileLabel.topAnchor.constraint(equalTo: tabGroupLabel.bottomAnchor),
            profileLabel.leftAnchor.constraint(equalTo: imageView.rightAnchor, constant: 6),
